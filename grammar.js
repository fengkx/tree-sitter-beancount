	...
	rules: {
		...
		binary_number_expr: $ =>
			prec(
				3,
				choice(
					prec.left(1, seq($._number_expr, $.plus, $._number_expr)),
					prec.left(1, seq($._number_expr, $.minus, $._number_expr)),
					prec.left(2, seq($._number_expr, $.asterisk, $._number_expr)),
					prec.left(2, seq($._number_expr, $.slash, $._number_expr)),
				),
			),
